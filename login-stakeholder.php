...
<head>
    ...
    <title>BPBD – Stakeholder Login</title>
...
<body class="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white flex items-center justify-center px-4">
    ...
    <div class="w-full max-w-md mt-12">
        ...
        <!-- heading -->
        <h1 class="text-2xl md:text-3xl font-bold text-center mb-8">Hai Stakeholder</h1>
        ...
        <div class="bg-white/10 backdrop-blur-sm rounded-2xl shadow-xl p-6 md:p-8 space-y-6">
            ...
            <form action="" method="post" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="username" id="username" required
                               class="w-full pl-10 pr-3 py-2 rounded-lg bg-white/10 border border-white/20 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-400">
                    </div>
                </div>
                ...
                <button type="submit" name="loginbtn"
                        class="w-full bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-2 rounded-lg transition">
                    Login
                </button>

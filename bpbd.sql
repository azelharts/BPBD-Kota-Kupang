...
CREATE TABLE `kejadian` (
  `id` int(11) NOT NULL,
  `jenis_id` json NOT NULL,
  `nama` json NOT NULL,
  `tanggal` date NOT NULL,
  `waktu` time NOT NULL,
  `provinsi` text NOT NULL,
  `kabkota` text NOT NULL,
  `kecamatan` json NOT NULL,
  `kelurahan` json NOT NULL,
